...
/* The Router Smart Contract enables automated market making and decentralized trades
...
contract R5Router is IR5Router02 {
    ...
    function addLiquidityBTN(
        ...
        address to,
        uint deadline
    ) external virtual payable ensure(deadline) returns (uint amountToken, uint amountBTN, uint liquidity) {
        (amountToken, amountBTN) = _addLiquidity(
            token,
            WETH,
            amountTokenDesired,
            msg.value,
    ...
    function removeLiquidityBTN(
        ...
        address to,
        uint deadline
    ) public ensure(deadline) returns (uint amountToken, uint amountBTN) {
        return removeLiquidityETH(token, liquidity, amountTokenMin, amountBTNMin, to, deadline);
    }
    function removeLiquidityWithPermit(
        address tokenA,
        address tokenB,
    ...
    function removeLiquidityBTNWithPermit(
        address token,
        uint liquidity,
        uint amountTokenMin,
        uint amountETHMin,
    ...
    function removeLiquidityBTNSupportingFeeOnTransferTokens(
        address token,
        uint liquidity,
        uint amountTokenMin,
        uint amountETHMin,
    ...
    function removeLiquidityBTNWithPermitSupportingFeeOnTransferTokens(
        address token,
        uint liquidity,
        uint amountTokenMin,
        uint amountBTNMin,
    ...
    function swapTokensForExactBTN(uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
        external
        ensure(deadline)
        returns (uint[] memory amounts)
    {
    ...
    function swapExactTokensForBTN(uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
        external
        ensure(deadline)
        returns (uint[] memory amounts)
    {
    ...
    function swapBTNForExactTokens(uint amountOut, address[] calldata path, address to, uint deadline)
        external
        payable
        ensure(deadline)
        returns (uint[] memory amounts)
    ...
    function swapExactTokensForBTNSupportingFeeOnTransferTokens(
        uint amountIn,
        uint amountOutMin,
        address[] calldata path,
        address to,
